#### This file takes a all of the .csv files in a directory, filters the files, calculates statistical functionals
...
#### Functions ####
setwd("~/YOUR/DIRECTORY/Affective_Eye_Gaze")  # main functions directory
...
for(counter in 1:length(csv_file_list))
{
  ...
  mytable <- mytable[,c(1,3:10,13:244,246:278,280:length(mytable)):=NULL]   #  Remove data unrelated to eye gaze
